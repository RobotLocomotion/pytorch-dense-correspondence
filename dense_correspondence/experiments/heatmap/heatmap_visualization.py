...
############ PUSH BOX REAL ###################
multi_episode_dict = load_push_box_episodes()
model_file = get_push_box_model_file()

############ CATERPILLAR_9 ############
# multi_episode_dict = load_caterpillar_episodes()
# model_file = get_caterpillar_model_file()
...
heatmap_vis = HeatmapVisualization(model_config, dataset, model, visualize_3D=False)
heatmap_vis.run()
